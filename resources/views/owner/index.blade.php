        ...
        <main class="py-4">
            <div class="container">
                <div class="row ">
                    ...
                    <div class="col-md-2">
                        <a href="#" data-toggle="modal" data-target="#staticBackdrop{{Auth::id()}}" class="btn btn-primary btn-sm" rel="noopener noreferrer">Create Shop</a><br><br>
                    </div>
                </div>
                <hr><br>
...
@include('owner/models.shop_registration')
                </div>
            </div>
        </main>
    </div>
